...
def _append_field_candidates(pool: list[dict], value: str, base_url: str, source_type: str) -> None:
...
def _add_scrape_candidate(pool: list[dict], raw_url: str, page_url: str, source_type: str) -> None:
